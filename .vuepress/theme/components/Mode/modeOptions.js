const modeOptions = {
  ...
  dark: {
    ...
    '--background-color': '#1c1c28',//'#050d21',
    '--box-shadow': '0 1px 8px 0 #42536d',
    '--box-shadow-hover': '0 2px 16px 0 #42536d',
    '--text-color': 'rgba(189, 195, 199, 0.8)',
    '--text-color-sub': 'rgba(189, 195, 199, 0.8)',
